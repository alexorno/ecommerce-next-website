...
const index = ({
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Best Selling Products"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Landing of your choice")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
const getServerSideProps = async () => {
  ...
  const products = await _lib_client_js__WEBPACK_IMPORTED_MODULE_2__/* .client.fetch */ .L.fetch(query);
  const bannerQuery = `*[_type == "banner"]`;
  const bannerData = await _lib_client_js__WEBPACK_IMPORTED_MODULE_2__/* .client.fetch */ .L.fetch(bannerQuery);
  return {
    props: {
      products,
      bannerData
